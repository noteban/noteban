...
use objc2_foundation::{
  NSBundle, NSError, NSObject, NSObjectProtocol, NSSet, NSString,
  NSUserActivity,
};
use objc2_ui_kit::{
...
// Whether UIKit allows this app to display multiple scenes.
...
// Scene lifecycle adoption is independent of support for additional windows.
